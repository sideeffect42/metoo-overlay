...
SRC_URI="https://download.flashrom.org/releases/${PN}-v${PV}.tar.bz2"
S="${WORKDIR}/${PN}-v${PV}"
...
IUSE_PROGRAMMERS="
atahpt +atapromise +atavia +buspirate_spi +ch341a_spi +dediprog developerbox_spi digilent_spi +drkaiser +dummy +ft2232_spi +gfxnvidia +internal +it8212 jlink_spi linux_mtd +linux_spi mstarddc_spi +nic3com +nicintel +nicintel_eeprom +nicintel_spi nicnatsemi +nicrealtek +ogp_spi +pickit2_spi +pony_spi +rayer_spi +satamv +satasii +serprog +usbblaster_spi"
